...
const BarChart2 = observer(() => {
    ...
    const [options, setOptions] = useState({});
     // Функция для выбора цвета на основе rawRollId
            ...
            setOptions({
                ...
                scales: {
                    x: {
                        ...
                        time: {
                            // Настройки форматирования времени могут быть адаптированы под ваши нужды
                            unit: 'minute',
                    ...
                    y: {
                        ...
                        max: maxDiameter, // Установка максимального значения для оси Y
                        grid: {
                            drawTicks: true,
                            tickLength: 5,
                        }
